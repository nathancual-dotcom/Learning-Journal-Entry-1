...
Q3. What I’m most interested in is the use of AI  able to aggregate, identify, calculate and express any recurring pattern or trends present within the data set. While in school I had to do a research that required a lot of manual analysis to identiy any the reoccuring patterns present within the data. 
...
Q3. If the system was not coded properly then it would result in instances where the total sales of the store is inflated, deflated or cases where items are incorrectly categorized and the alarms go off incorrectly or not at all. This would not only affect the customers but the establishment as a whole as their view of their current stock and finances would become dubious. 
